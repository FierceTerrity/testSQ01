...
export const chatCommands: TPluginProps = (state, options) => {
  ...
  const admins = (data: TChatMessage) => {
    ...
    adminWarn(
      execute,
      data.steamID,
      '-✯- Для связи с администрацией/модераторами создайте тикет в дискорде  discord.gg/bestinhell -✯-',
    );
  };
  ...
  const report = (data: TChatMessage) => {
    ...
    adminWarn(
      execute,
      data.steamID,
      `-✯- Если вы зафиксировали грубое нарушение -> Пожалуйста создайте тикет в нашем дискорде discord.gg/bestinhell -✯-`,
    );
  };
  ...
  const discord = (data: TChatMessage) => {
    ...
    adminWarn(
      execute,
      data.steamID,
      '-✯- Discord сервера - discord.gg/bestinhell -✯-',
    );
    adminWarn(
      execute,
      data.steamID,
      '-✯- Либо в дискорде Добавить сервер -> Лучшие в Аду -✯-',
    );
  };
  ...
  const bonus = async (data: TChatMessage) => {
    ...
    adminWarn(
      execute,
      steamID,
      'Для получения вип-статуса      используйте !vip в нашем дискорде                 -✯-  discord.gg/bestinhell -✯-',
    );
